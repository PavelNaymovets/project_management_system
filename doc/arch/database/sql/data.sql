...
values
    ('384f508c-3016-3bf1-9334-6ccc1ca21c36', 'Прохорова', 'Инна', 'Андреевна', 'инженер ui тестирования', 'vil53', 'vil534@example.com', '1'),
...
values
    ('1220680', 'система управления проектами', 'Взаимодействие корпорации и клиента традиционно специфицирует ролевой анализ зарубежного опыта Баинг и селлинг, безусловно, экономит продвигаемый повторный контакт', 'в разработке'),
...
values
    ('Подготовить Liquebase-скрипт', 'Переложить скрипт, созданный в п.2 на Liquebase-скрипт(xml/yaml что хотите). В этом ДЗ запускать не требуется', '1', '1', '3', '2029-02-09', 'новая', '1'),

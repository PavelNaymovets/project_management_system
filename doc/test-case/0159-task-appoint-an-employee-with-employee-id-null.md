# 159 Обновление исполнителя задачи с указанием id исполнителя = null
...
Обновление исполнителя задачи с указанием id исполнителя = null.
...
Выполнится HTTP запрос с методом `PUT` на endpoint `http://localhost:8080/pms/api/v1/task/employee?taskId=sdfdsfs&employeeId=null`.
...
```
{
    "timestamp": "2023-06-15T15:52:29.161+00:00",
    "status": 400,
    "error": "Bad Request",

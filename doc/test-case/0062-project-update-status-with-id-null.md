# 62: Обновление статуса проекта с указанием id = null
...
Обновление статуса проекта с указанием id = null
...
* Выполнится HTTP запрос с методом `GET` на endpoint `http://localhost:8080/pms/api/v1/project/status?id=null&status=черновик`.
...
```
{
    "timestamp": "2023-06-14T11:30:44.980+00:00",
    "status": 400,
    "error": "Bad Request",

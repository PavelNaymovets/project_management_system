# 146: Обновление статуса задачи с указанием id = null
...
Обновление статуса задачи с указанием id = null
...
Выполнится HTTP запрос с методом `PUT` на endpoint `http://localhost:8080/pms/api/v1/task/status?id=null&status=закрыта`.
...
```
{
    "timestamp": "2023-06-15T14:21:33.181+00:00",
    "status": 400,
    "error": "Bad Request",

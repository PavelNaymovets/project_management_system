# 645 Обновление статуса проекта со статусом null
...
Выполнится HTTP запрос с методом `PUT` на endpoint `http://localhost:8080/pms/api/v1/project/status?id=1&status=null`. 
